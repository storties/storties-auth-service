...
class JwtTokenProviderTest {
    ...
    void testCreateToken() {
        ...
        String token = jwtTokenProvider.createToken(id, userName, role);  // userName 추가
    ...
    void testGetAuthentication() {
        String token = jwtTokenProvider.createToken(1L, "testUser", Role.ADMIN);
    ...
    void testValidateToken_ExpiredToken() {
        // 만료된 토큰을 테스트할 수 있게끔 만료 시간을 조작 (시계 바꾸기 등)
    ...
    private String createExpiredToken() {
        ...
        return expiredTokenProvider.createToken(1L, "testUser", Role.ADMIN);  // userName 추가
    }
}
